...
He desarrollado este sistema para resolver el reto de integración de automatización de Loebes CRM. Mi objetivo ha sido conectar el CRM con un flujo de trabajo en n8n y un servicio backend propio de una forma eficiente y siguiendo los requisitos del proyecto.
...
1. Loebes CRM: Donde gestiono los leads y las tareas, y donde se guardan los logs de actividad.
...
He preparado un archivo JSON en la carpeta /n8n-workflow que se puede importar directamente en n8n. He dejado configurados los webhooks en modo producción y los nodos para que se comuniquen con la API de Loebes usando mi token.
